...
import * as sty from "./PlasmicTrend.module.css"; // plasmic-import: T8T_aZ-pF5ms/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__nfEbj)}
      >
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(defaultcss.all, sty.freeBox__enEw2)}>
        <div className={classNames(defaultcss.all, sty.freeBox__puQ97)}>
          {p.renderPlasmicSlot({
            defaultContents:
