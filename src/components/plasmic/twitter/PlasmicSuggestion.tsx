...
import * as sty from "./PlasmicSuggestion.module.css"; // plasmic-import: WACyS-tsqYl2/css
...
function PlasmicSuggestion__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__m747Z)}
      ...
      <div className={classNames(defaultcss.all, sty.freeBox__yF1Ns)}>
        <div className={classNames(defaultcss.all, sty.freeBox__slIv9)}>
          <div className={classNames(defaultcss.all, sty.freeBox__yyjry)}>
            {p.renderPlasmicSlot({
        ...
        <div className={classNames(defaultcss.all, sty.freeBox__rlgE)}>
          {p.renderPlasmicSlot({
